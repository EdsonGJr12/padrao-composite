public class Main {
	...
	public static void main(String[] args) {
		...
		/**
		 * Criação de 3 grupos. O itemPermissao5 é um grupo formado pelo grupo
		 * itemPermissao4 e pelo usuário itemPermissao3, portanto forma uma árvore
		 * 
		 */
		...
		/**
		 * Permissão TESTE2 concedido para o grupo itemPermissao5, consequentemente para
		 * todos os usuários da árvore
		 *
		 */
